...
// clang-format off
#define MPPP_VERSION_STRING "0.26"
#define MPPP_VERSION_MAJOR 0
#define MPPP_VERSION_MINOR 26
#define MPPP_GMP_HAVE_MPN_DIVEXACT_1
...
/* #undef MPPP_MPFR_HAVE_MPFR_GET_STR_NDIGITS */

/* #undef MPPP_ARB_HAVE_ACB_AGM */

#define MPPP_WITH_QUADMATH
#define MPPP_QUADMATH_HAVE_EXP2Q
#define MPPP_QUADMATH_HAVE_LOGBQ

/* #undef MPPP_WITH_BOOST_S11N */
// clang-format on

    ...
    public:
        ...
        observable hemisphere_sampling_2(vector<vector<double>> constituents, int n_constituents, vector<double> final_parton, int* spins, double a){
            ...
            if(n_constituents==2){
                ...
                vector<double> p1p2={constituents_boosted[0][0]+constituents_boosted[1][0],constituents_boosted[0][1]+constituents_boosted[1][1],constituents_boosted[0][2]+constituents_boosted[1][2],constituents_boosted[0][3]+constituents_boosted[1][3]};
                vector<double> p1p3={constituents_boosted[0][0]+constituents_boosted[2][0],constituents_boosted[0][1]+constituents_boosted[2][1],constituents_boosted[0][2]+constituents_boosted[2][2],constituents_boosted[0][3]+constituents_boosted[2][3]};
                vector<double> p2p3={constituents_boosted[1][0]+constituents_boosted[2][0],constituents_boosted[1][1]+constituents_boosted[2][1],constituents_boosted[1][2]+constituents_boosted[2][2],constituents_boosted[1][3]+constituents_boosted[2][3]};
        ...
        observable hemisphere_sampling_3(vector<vector<double>> constituents, int n_constituents, vector<double> final_parton, int* spins, double a){
            ...
            for(int i=0; i<n_constituents; i++){
                //cout<<constituents[i][0]<<" "<<constituents[i][1]<<" "<<constituents[i][2]<<" "<<constituents[i][3]<<endl;
                tot={tot[0]+constituents[i][0],tot[1]+constituents[i][1],tot[2]+constituents[i][2],tot[3]+constituents[i][3]};
            };
            ...
            // cout<<"*****"<<endl;
            // for(int i=0; i<n_constituents; i++){
            //     cout<<constituents_boosted[i][0]<<" "<<constituents_boosted[i][1]<<" "<<constituents_boosted[i][2]<<" "<<constituents_boosted[i][3]<<endl;
            // };
            // cout<<"tot "<<jacques_vecs[0][0]<<" "<<jacques_vecs[0][1]<<" "<<jacques_vecs[0][2]<<" "<<jacques_vecs[0][3]<<endl;
            ...
            //cout<<"hardest one  "<<constituents_boosted[index][0]<<" "<<constituents_boosted[index][1]<<" "<<constituents_boosted[index][2]<<" "<<constituents_boosted[index][3]<<endl;
            ...
            //cout<<"other jet  "<<total_p[0]<<" "<<total_p[1]<<" "<<total_p[2]<<" "<<total_p[3]<<endl;
            ...
            if(total_m<lambda*pow(eCM,2.) && total_s<2){
                ...
                vector<double> hardest_particle=constituents_boosted[index];
                vector<double> other_jet=total_p;

                vector<vector<double>> jets={hardest_particle, hardest_particle, hardest_particle, other_jet};
                ...
                double txy=r_flow.t_val(jets[0],1);
                ...
                // cout<<"***"<<endl;
                // cout<<jets[0][0]<<" "<<jets[0][1]<<" "<<jets[0][2]<<" "<<jets[0][3]<<endl;
                // cout<<jets[3][0]<<" "<<jets[3][1]<<" "<<jets[3][2]<<" "<<jets[3][3]<<endl;
                
                double tyz=r_flow.t_val(jets[0],2);
    ...
    public:
        ...
        observable_c NLO_se_DrellYan_integrand(vector<double> k, vector<double> l, vector<double> q, double a, int comp){
            ...
            if(comp==1){
                ...
                dcomp integrand_val=extra_const*constant*(se_virtual_1+se_virtual_2+0.5*se_uv);
